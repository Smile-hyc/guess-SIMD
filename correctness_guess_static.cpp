...
// 编译指令如下
// g++ correctness_guess_static.cpp train.cpp guessing.cpp md5.cpp -o correctness_guess_static -O2 -pthread
...
int main(int argc, char* argv[])
{
    ...
    // argv[1]：线程数，例如 ./correctness_guess_static 8
    // argv[2]：并行阈值，例如 ./correctness_guess_static 8 1000
    if (argc >= 2)
    {
